...
import ga.hnbenterprises.like_birbs.LogListAdapter;
import ga.hnbenterprises.like_birbs.LogMsg;
import ga.hnbenterprises.like_birbs.R;

public class DisplayBirbs extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder
                .setTitle("CURRENT BIRBS IN COLONY")
